...
public class PedidosController {
	...
	@Operation(summary = "Inserir um pedido", 
		description = "Endpoint para inserir um novo pedido.")
	public ResponseEntity<String> post() {
		return ResponseEntity.ok("Pedido inserido com sucesso.");
	}
	@PutMapping
	@Operation(summary = "Atualizar um pedido", 
		description = "Endpoint para atualizar um pedido existente.")
	public ResponseEntity<String> put() {
		return ResponseEntity.ok("Pedido atualizado com sucesso.");
	}
	@DeleteMapping
	@Operation(summary = "Excluir um pedido", 
		description = "Endpoint para excluir um pedido existente.")
	public ResponseEntity<String> delete() {
		return ResponseEntity.ok("Pedido excluído com sucesso.");
	}
	@GetMapping
	@Operation(summary = "Obter um pedido", 
		description = "Endpoint para obter os dados de um pedido existente.")
